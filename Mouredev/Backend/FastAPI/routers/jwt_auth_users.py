...
# "3d201d372020c009416c1ddf9713ef7576bdf08351fabcda1c58a4432885d865"
...
users_db = {
    "santiago": { 
        "username": "santiago",# Lo que se pasa al post es santiago no sms
        "full_name": "santiago sanbbria",
        "email": "sms@gmail.com",
        "disabled": False,
...
async def auth_user(token: str = Depends(oauth2)):
    ...
    try:
        ...
        if username is None: #Si username esta vacio
            raise exception

    except JWTError:
        raise exception

    return search_user(username)# Si todo sakle bien
